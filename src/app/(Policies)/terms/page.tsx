    ...
    <>
      ...
      <div className="p-4 md:p-20 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xl opacity-80">
            We employ the use of cookies. By accessing Weugly's website, you agreed to
            use cookies in agreement with Weugly's Privacy Policy.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xl opacity-80">
            Unless otherwise stated, Weugly and/or its licensors own the intellectual
            property rights for all material on Weugly. All intellectual property
            rights are reserved. You may access this from Weugly for your own personal
            use subjected to restrictions set in these terms and conditions.
          </p>
        </div>

        <div>
          <h1 className="text-3xl font-bold">You must not</h1>
          <ol className="list-decimal mx-10 my-5 flex flex-col gap-2">
            <li className="text-md opacity-80">Republish material from Weugly</li>
            <li className="text-md opacity-80">Sell, rent, or sub-license material from Weugly</li>
            <li className="text-md opacity-80">Reproduce, duplicate, or copy material from Weugly</li>
          </ol>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xl opacity-80">
            In no event shall Weugly, nor any of its officers, directors, and employees,
            be held liable for anything arising out of or in any way connected with your
            use of this website, whether such liability is under contract. Weugly,
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xl opacity-80">
            Weugly is permitted to revise these terms at any time as it sees fit, and by
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xl opacity-80">
            These terms constitute the entire agreement between Weugly and you in
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xl opacity-80">
            ...
            the jurisdiction of India, and you submit to the non-exclusive jurisdiction of
            the state and federal courts located in Bangalore for the resolution of any
            disputes.
            <br />
